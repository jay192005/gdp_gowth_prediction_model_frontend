...
const firebaseConfig = {
  apiKey: import.meta.env.VITE_FIREBASE_API_KEY || "AIzaSyDxxx",
  ...
  storageBucket: import.meta.env.VITE_FIREBASE_STORAGE_BUCKET || "gdp-grow-prediction-model.appspot.com",
